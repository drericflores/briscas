...
mkdir -p "$build_dir/DEBIAN" "$build_dir/usr/bin" \
  ...
  "$build_dir/usr/share/icons/hicolor/256x256/apps" "$build_dir/usr/share/doc/briscas" "$output_dir"
...
install -m 0644 "$project_dir/assets/cards/posterior.png" "$build_dir/usr/share/icons/hicolor/256x256/apps/com.ericflores.briscas.png"
